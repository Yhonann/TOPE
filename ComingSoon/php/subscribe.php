<?php
  require_once('~/php/vendor/MCAPI.class.php');

  // version, 1 = save to txt file, 2 = mailchimp
  $version = 2;

  // http://admin.mailchimp.com/account/api/
  define('MC_API_KEY', 'b24750dacd734232f343ed4f2c790d75-us17');

  // http://admin.mailchimp.com/lists/
  define('MC_LIST_ID', 'bfa2207d4d');
  ...
  define('FILE_PATH', 'TOPEMailingList13579.txt');
